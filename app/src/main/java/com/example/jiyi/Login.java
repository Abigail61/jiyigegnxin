...
import com.example.jiyi.login.Code;
import com.example.jiyi.db.DBOpenHelper;
import com.example.jiyi.login.Register;
...
public class Login extends AppCompatActivity implements View.OnClickListener {
    ...
    private String trueusername="JiYi";
                ...
                if (!TextUtils.isEmpty(name) && !TextUtils.isEmpty(password) && !TextUtils.isEmpty(phoneCode)) {
                    ...
                    if (phoneCode.equals(realCode)) {
                        ...
                        if (match) {
                            ...
                            intent.putExtra("trueusername",trueusername);
